...
# %% auto 0
__all__ = ['API_URL', 'logger', 'database_url', 'database_superuser_url', 'secret', 'database', 'database_superuser', 'config',
           's3_client', 'T', 'api_key', 'audio_editor', 'PermissionsLevel', 'RegisterResponse', 'LoginResponse',
           'schema', 'graphql_app', 'app', 'origins', 'JwtPayload', 'create_jwt', 'decode_jwt', 'Context',
           'IsAuthenticated', 'FormError', 'FormErrors', 'handle_form_validation_errors', 'create_presigned_url',
           'retry_on_operational_error', 'transcribe_and_save_file', 'run_remote_transcribe_and_save_file', 'Employee',
           'User', 'Word', 'UtteranceSegmentInput', 'Utterance', 'Clip', 'Video', 'Company', 'FileStatus',
           'FileMetadata', 'Transcription', 'RegisterCompanySuccess', 'FileType', 'FileMetadataInput', 'LoginSuccess',
           'CreateVideoRequest', 'create_video_async', 'Query', 'Mutation', 'get_context']
...
async def run_remote_transcribe_and_save_file(
    ...
    signed_url = create_presigned_url(file_metadata.file_path)
