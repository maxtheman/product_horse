...
# %% auto 0
__all__ = ['API_URL', 'database_url', 'database_superuser_url', 'secret', 'database', 'database_superuser', 'api_key',
...
class Mutation:
    ...
    async def create_video_from_utterances(
        ...
        print(remote_url)
        print(info.context.employee.id)
