...
# %% auto 0
__all__ = ['API_URL', 'logger', 'database_url', 'database_superuser_url', 'secret', 'database', 'database_superuser', 'T',
           'api_key', 'audio_editor', 'PermissionsLevel', 'RegisterResponse', 'LoginResponse', 'schema', 'graphql_app',
           'app', 'origins', 'JwtPayload', 'create_jwt', 'decode_jwt', 'Context', 'IsAuthenticated', 'FormError',
           'FormErrors', 'handle_form_validation_errors', 'retry_on_operational_error', 'transcribe_and_save_file',
           ...
           'FileType', 'FileMetadataInput', 'LoginSuccess', 'CreateVideoRequest', 'create_video_async', 'Query',
...
#     utterance_segments_inputs=[...],  # List of UtteranceSegmentInput objects
...
class Mutation:
    ...
    async def create_video_from_utterances(
        ...
        video_shell = database.as_employee(info.context.employee).save_video(video_to_make)
        asyncio.create_task(create_video_async( 
            api_url="http://gpu-product-horse.flycast",
            jwt_token=info.context.jwt,
            video_id=video_shell.id,
