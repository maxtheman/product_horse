...
# %% auto 0
__all__ = ['save_mp4_animation_to_file', 'put_words_over_video_subset', 'write_video', 'write_video_with_audio', 'render_clip',
...
def write_video_with_audio(output_path: str, video_clip: VideoClip | VideoFileClip | CompositeVideoClip, buffer_size: int = 900000):
    # Video properties
    ...
    if video_clip.audio is not None:
        ...
        if not hasattr(video_clip.audio, 'fps'):
            video_clip.audio.write_audiofile(temp_audio_file.name, fps=audio_fps_default)
        else:
